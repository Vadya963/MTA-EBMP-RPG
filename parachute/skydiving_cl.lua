...
local function onRender()
	...
	if tickDiff > 0 then
		if ( getPedWeapon ( localPlayer, 11 ) == 46 ) and not getElementData(localPlayer, "parachuting") and not isElementAttached(localPlayer) and not isPedDead(localPlayer) then
