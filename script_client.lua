...
local down_player_subject = {--3d text
	...
	{681.732421875,879.7626953125,-39.562740325928, 1, text4},
	{695.19219970703,886.27130126953,-38.105506896973, 1, text4},
	{691.26837158203,906.04571533203,-38.310031890869, 1, text4},
	{677.27325439453,908.61407470703,-39.635219573975, 1, text4},
	{672.15020751953,892.13360595703,-39.225635528564, 1, text4},
...
function createText ()
	...
	if debuginfo == "true" then
		...
		dxdrawtext ( "skin "..getElementModel(playerid), 300.0, 70.0, 0.0, 0.0, tocolor ( white[1], white[2], white[3], 255 ), 1, m2font_dx1 )
