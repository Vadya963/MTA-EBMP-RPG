...
local down_player_subject = {--{x,y,z, радиус 4, ид пнг 5, интерьер 6, мир 7} также нужно прописать ид пнг в throw_earth_server
...
local anim_player_subject = {--{x,y,z, радиус 4, ид пнг1 5, ид пнг2 6, зп 7, анимация1 8, анимация2 9, интерьер 10, мир 11, время работы анимации 12}
	--завод продуктов
