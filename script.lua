...
local up_player_subject = {--{x,y,z, радиус, ид пнг, зп, интерьер, мир}
	...
	{576.8212890625,846.5732421875,-42.264389038086, 5, 70, 1, 0, 0},--рудник лв
}
...
local anim_player_subject = {--{x,y,z, радиус, ид пнг1, ид пнг2, зп, анимация1, анимация2, интерьер, мир, время работы анимации}
	--завод продуктов
